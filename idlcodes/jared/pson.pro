...
; \
; Get size of the page (centimeters)
...
page_width = widths[index]
page_height = heights[index]
...
; \
; Get aspect ratio from the current graphics window
...
; (landscape method is different than the printer method)
