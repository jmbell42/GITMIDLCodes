...
;****************************************************************
; WINDII Level 2 V500 FD HDF Data Reading Utility
; Date: December 1996
...
;
; Modified March, 1997 by Shengpan
; Reason: corresponding to the change in w_l2fd_hdf.pro, so the UNIX and PC
;         users can read the header information properly
;
;****************************************************************
...
pro version
        print,' '
        print,'     WINDII Level 2 V500 FD HDF Data Reading Utility'
...
pro usage
  ...
  print,' '
  print,"    file,'path+fd1(or fd2)+uday' "
  print,' '
  print,"    Example       : file,'sdp:[sdpps.cdhf.dat.hdf_v500]fd10502'"
  print,"    Example for O2: file,'sdp:[sdpps.cdhf.dat.hdf_v500]fo10510'"
  print,' '
