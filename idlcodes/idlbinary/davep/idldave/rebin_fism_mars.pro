...
fismfile = file_search('~/UpperAtmosphere/FISM/Mars/FISM*60sec*_'+cyear+cdoy+'_*.sav')
fismfile = fismfile(0)

if strpos(fismfile,'.sav') ge 0 then begin
    restore,fismfile
    newfile = '~/UpperAtmosphere/FISM/Mars/BinnedFiles/fismflux'+cyear+cmon+cday+'.dat'
;    newfile = 'fism.dat'
