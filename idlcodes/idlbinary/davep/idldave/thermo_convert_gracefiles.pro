...
if (n_elements(dirin) eq 0) then dirin = '~/UpperAtmosphere/GRACE/data/'
dirin = ask('directory for GRACE data',dirin)
...
filein = dirin+'/'+year+'/Density_graceA_3deg_'+chopr(year,2)+'_'+julian+'.ascii'
