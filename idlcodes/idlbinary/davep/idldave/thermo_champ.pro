...
if (n_elements(data) gt 0) then begin
    filelist_new = file_search('????_*.dat')
...
endif else filelist_new = file_search('????_*.dat')
...
oplot, [t1,t2], [1.0,1.0]*1e-12, thick = 3, linestyle = 2, color = 250
xyouts, t3, 1.0e-12, 'GITM', color = 250

oplot, [t1,t2], [2.0,2.0]*1e-12, thick = 3
xyouts, t3, 2.0e-12, 'CHAMP'
