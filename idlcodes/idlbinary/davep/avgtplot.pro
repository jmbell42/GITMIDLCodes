...
yep=0
set_plot,'ps'
device,filename='tAvgplot.ps',/color
loadct,39
!p.multi=[0,1,3,0,0]
;TEMPERATURE
...
for i=0,dayo-1 do begin
 tplot=fltarr(counter(i))
tplot(*)=t_avgsum(i,13)
oplot, time(i*12:i*12+11)-stime, tplot,color =70
endfor
;RHO
 plot,time-stime,intarr(n_elements(time)), $
...
oplot,time(i*12:i*12+11)-stime , rplot,color =70
endfor
;NO2RATIO
 plot,time-stime,intarr(n_elements(time)), $
...
oplot, time(i*12:i*12+11)-stime, onplot,color =70
endfor
closedevice
