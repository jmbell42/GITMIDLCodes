...
dzenmax1 = fltarr(nfiles)
dzenmax2 = fltarr(nfiles)
nzenmax1 = fltarr(nfiles)
nzenmax2 = fltarr(nfiles)
max1 = fltarr(nfiles)
max2 = fltarr(nfiles)
    ...
    for iFile = 0, nf - 1 do begin
        ...
        for ilat = 0, nlats - 1 do begin
            for ilon = 0, nlons - 1 do begin
                ...
                if smalldir eq 0 then begin
                    tempavg1 = (data1(ivar,ilon,ilat,ialt1)-data2(ivar,ilon,ilat,ialt1))/$
                      data2(ivar,ilon,ilat,ialt1)*100.
                    tempavg2 = (data1(ivar,ilon,ilat,ialt2)-data2(ivar,ilon,ilat,ialt2))/$
                      data2(ivar,ilon,ilat,ialt2)*100.
                endif else begin
                    tempavg1 = (data2(ivar,ilon,ilat,ialt1)-data1(ivar,ilon,ilat,ialt1))/$
                      data2(ivar,ilon,ilat,ialt1)*100.
                    tempavg2 = (data2(ivar,ilon,ilat,ialt2)-data1(ivar,ilon,ilat,ialt2))/$
                      data1(ivar,ilon,ilat,ialt2)*100.
                endelse
                
                if max1(ifile) lt tempavg1 then begin
                    max1(ifile) = tempavg1
                    dzenmax1(ifile) = zenith
                endif
                if max2(ifile) lt tempavg2 then begin
                    max2(ifile) = tempavg2
                    dzenmax2(ifile) = zenith
                endif
                ...
                if zenith lt 30 and abs(data1(1,0,ilat,0)*180/!pi) le 90. $
                  ...
                  then begin 
                    ...
                    if smalldir eq 0 then begin
                        ...
                        tempavg1 = (data2(ivar,ilon,ilat,ialt1)-data1(ivar,ilon,ilat,ialt1))/$
                          data1(ivar,ilon,ilat,ialt1)*100.
                        tempavg2 = (data2(ivar,ilon,ilat,ialt2)-data1(ivar,ilon,ilat,ialt2))/$
                          data1(ivar,ilon,ilat,ialt2)*100.
                    endelse
                ...
                if zenith gt 150 and abs(data1(1,0,ilat,0)*180/!pi) le 90. $
                  ...
                  then begin
                    ...
                    if nightmax2(ifile) lt tempavg2 then begin
