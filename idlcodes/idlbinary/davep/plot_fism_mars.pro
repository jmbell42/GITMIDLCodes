...
;
;yrange = [0,2e-5]
;lot,rtime-stime,fismflux(pwave(0),*),xtickv=xtickv,xticks=xtickn,$
; xminor=xminor,xtickname=strarr(10)+' ',xstyle=1,pos=pos1,/noerase,$
; ytitle='Flux ('+tostrf(waveavg(pwave(0)))+' nm) W/m!U2!D';,yrange=yrange,$
;     ystyle=1
;
;et_position, ppp, space, sizes, 1, pos1, /rect
;os1(0) = pos1(0) + 0.1
;
;range = [0,3e-4]
;lot,rtime-stime,fismflux(pwave(1),*),xtickv=xtickv,xticks=xtickn,$
; xminor=xminor,xtickname=strarr(10)+' ',xstyle=1,pos=pos1,/noerase,$
; ytitle='Flux ('+tostrf(waveavg(pwave(1)))+' nm) W/m!U2!D';,yrange=yrange,$
;     ystyle=1
;
;et_position, ppp, space, sizes, 2, pos1, /rect
;os1(0) = pos1(0) + 0.1
;
;range = [0,6e-4]
;lot,rtime-stime,fismflux(pwave(2),*),xtickv=xtickv,xticks=xtickn,$
; xminor=xminor,xtickname=strarr(10)+' ',xstyle=1,pos=pos1,/noerase,$
...
yrange = [0,0.1]
plot,rtime-stime,fismflux(pwave(0),*),xtitle=xtitle,xtickv=xtickv,xticks=xtickn,$
     xminor=xminor,xtickname=xtickname,xstyle=1,pos=pos1,/ylog,$
     ytitle='Flux ('+tostrf(waveavg(pwave(0)))+' nm) W/m!U2!D',/noerase,thick=2,$
     charsize =1.2
closedevice
