; $Id: //depot/idl/IDL_63_RELEASE/idldir/lib/itools/ui_widgets/idlitwdtool.pro#1 $
;
...
pro IDLitwdTool_resize, pState, deltaW, deltaH
    ...
    ; of the draw widget.
    newVisW = (drawgeom.xsize + deltaW) > (*pState).minsize[0]
    newVisH = (drawgeom.ysize + deltaH) > (*pState).minsize[1]
