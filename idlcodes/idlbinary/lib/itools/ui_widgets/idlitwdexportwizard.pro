; $Id: //depot/idl/IDL_63_RELEASE/idldir/lib/itools/ui_widgets/idlitwdexportwizard.pro#1 $
;---------------------------------------------------------------------------
...
@idlit_catch.pro
   ...
   widget_control, wWizard, get_uvalue=pState
    ...
    oItem = State.oTool->GetByIdentifier((*sEvent.value)[0])
