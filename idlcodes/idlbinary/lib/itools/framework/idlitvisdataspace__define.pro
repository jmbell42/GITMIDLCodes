; $Id: //depot/idl/IDL_63_RELEASE/idldir/lib/itools/framework/idlitvisdataspace__define.pro#1 $
;
...
;   IDLgrPolyline                   log
;
pro IDLitVisDataSpace::_SetLog, X_LOG=xLog, Y_LOG=yLog, Z_LOG=zLog
...
pro IDLitVisDataSpace::SetProperty, $
    ...
    if N_ELEMENTS(xLog) || N_ELEMENTS(yLog) || N_ELEMENTS(zLog) then begin
        self->_SetLog, X_LOG=xLog, Y_LOG=yLog, z_LOG=zLog
    endif
