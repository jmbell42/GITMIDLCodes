; $Id: //depot/idl/IDL_63_RELEASE/idldir/lib/itools/framework/idlitsystem__define.pro#1 $
;
...
pro IDLitSystem::_ResetSettings
   ...
   if (OBJ_VALID(oGeneral)) then BEGIN
     oGeneral->_UpdateAvailableLanguages
     oGeneral->_UpdateDefaultStyleNames
   ENDIF
...
function IDLitSystem::CreateVisualization, idTool, oData, $
   ...
   oCreate = oTool->GetService("CREATE_VISUALIZATION")
    ...
    if (nextra gt 0) then begin
        filterOutProps = [dataspaceProps, axisProps]
