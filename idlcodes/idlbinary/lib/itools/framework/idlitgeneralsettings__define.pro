; $Id: //depot/idl/IDL_63_RELEASE/idldir/lib/itools/framework/idlitgeneralsettings__define.pro#1 $
;
...
;
pro IDLitGeneralSettings::_UpdateDefaultStyleNames
...
;
pro IDLitGeneralSettings::_UpdateAvailableLanguages
  compile_opt hidden, idl2
