; $Id: //depot/idl/IDL_63_RELEASE/idldir/lib/itools/components/idlitopinsertlegenditem__define.pro#1 $
;
...
;   None.
;
function IDLitopInsertLegendItem::DoAction, oTool
    ...
    for i=0, N_ELEMENTS(oVisTargets)-1 do begin
        ...
        for j=0, count-1 do begin
            ...
            oLegendItems[j]->GetProperty, VIS_TARGET=representedTarget
            if (representedTarget eq oVisTargets[i]) then begin
                targetRepresented = 1
                break
            endif
        endfor
