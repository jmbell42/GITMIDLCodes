; $Id: //depot/idl/IDL_63_RELEASE/idldir/lib/itools/components/idlitvisimage__define.pro#1 $
;
...
pro IDLitVisImage::_RegisterProperties, $
    ...
    if (registerAll) then begin
        ...
        self->RegisterProperty, 'IMAGE_TRANSPARENCY', /INTEGER, $
    ...
    if (~registerAll && updateFromVersion lt 620) then begin
        ; Alpha channel property is now always available.
        self->SetPropertyAttribute, 'IMAGE_TRANSPARENCY', /SENSITIVE
    endif
...
pro IDLitVisImage::Restore
    ...
    if (self.idlitcomponentversion lt 620) then begin
        ...
        if (self._transparency ne 0) then $
            self->SetProperty, IMAGE_TRANSPARENCY=self._transparency
