; $Id: //depot/idl/IDL_63_RELEASE/idldir/lib/query_dicom.pro#2 $
;
...
FUNCTION QUERY_DICOM, file, info, IMAGE_INDEX = iIndex, DICOMEX=useDicomexIn
;+
; NAME:
; QUERY_DICOM
;
...
;-
  ...
  oDicom = useDicomex ? obj_new('idlffDicomEx', file, /NO_PIXEL_DATA) : $
           OBJ_NEW('IDLffDICOM')
