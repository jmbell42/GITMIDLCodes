...
;            print,'nfiles:',nfiles
            if filelist[0] eq '' or nfiles eq 0 then begin
                ...
                read_thermosphere_file_3gc, filelist, nvars, nalts, nlats, nlons,vars,data,rb,cb,bl_cnt, iTime
                (*ptr).bl_cnt = bl_cnt
...
;                    print,'n is:',n
                    ...
                    bl_cnt = 0
                                ;Read multiple files.
                    read_thermosphere_file_3gc, mulfiles(0), nvars, nalts, nlats, $
              ...
              ;If there are variables, then start to do the plot.  
                        if (vars(0) eq '') or (sel eq -1) or (cnt eq 0) then begin
                            ...
                            thermo_plot_3gc,cursor_x,cursor_y,strx,stry,step,vars,sel,nfiles,	  $
...
;                        print,nvars,nalts,nlats,nlons
                        ...
                        if n gt 1 then begin
                            for i = 0,n-1 do begin
                                ...
                                read_thermosphere_file_3gc, mulfiles(i), nvars, nalts,$
